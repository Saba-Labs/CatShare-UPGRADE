...
import { FiAlignLeft, FiArrowLeft, FiDroplet } from './builderSidebarIcons';
...
export default function FooterQuickPanel({
  ...
  const patch = (patchSettings: Partial<typeof siteSettings>) => {
    onUpdateWebsiteConfig({
  ...
  return (
    <div className="sidebar-panel">
      ...
      <SidebarSection title="Colors" icon={<FiDroplet />} description="Background, text, and accent">
        <FooterColorFields siteSettings={siteSettings} variant={variant} onPatch={patch} advanced />
      </SidebarSection>
      <SidebarSection title="Layout & content" icon={<FiAlignLeft />} description="Structure, links, and copy">

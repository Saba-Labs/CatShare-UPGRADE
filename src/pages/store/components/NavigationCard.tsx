  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <FiChevronRight className="h-4 w-4 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-300 flex-shrink-0 mt-0.5 transition-colors" />
      </div>
    </button>
  );
}
...
export default function OrderDetail() {
  ...
  const loadOrder = async () => {
    ...
    if (found) {
      ...
      setEditItems((found.items || []).map((it, i) => ({ ...it, _key: String(i) })));
    } else {
  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#F8FAFC', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
        <style>{`
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 12 }}>
          ...
          <span style={{ color: '#94A3B8', fontSize: 13 }}>Loading order…</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#F8FAFC', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 12, padding: 24 }}>
          ...
          <div style={{ fontSize: 15, fontWeight: 700, color: '#DC2626' }}>Order not found</div>
  ...
  return (
    <div {...swipeHandlers} style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#F8FAFC', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap');
        * { box-sizing: border-box; }
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {!editMode && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 5, color: '#64748B', fontSize: 12, marginTop: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              <IconCalendar />
              ...
              <div style={{ position: 'relative' }} onClick={e => e.stopPropagation()}>
                <button
                  ...
                  style={{
                    ...
                    padding: '0', borderRadius: 100, border: 'none',
                    cursor: 'pointer', fontFamily: 'inherit',
                  }}
                >

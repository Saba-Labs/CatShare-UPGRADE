        ...
        >
          ...
          {formSection === 'variants' && (
            <motion.div className="mb-5" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
              ...
              <div className="flex items-center justify-between mb-5 gap-3" style={!isPro ? { opacity: 0.6, pointerEvents: 'none' } : {}}>
                ...
                >
                  ...
                  <span className="hidden sm:inline">{showManageVariants ? 'View List' : 'Edit'}</span>
                  <span className="sm:hidden">{showManageVariants ? 'List' : 'Edit'}</span>
                </motion.button>
              </div>
              <motion.div

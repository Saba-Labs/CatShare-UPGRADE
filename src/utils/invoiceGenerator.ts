...
function drawFooter(pdf: jsPDF, pageWidth: number, pageHeight: number) {
  ...
  addUniformText(pdf, 'This is a computer generated document.', MARGIN, textY, 3.5, '#94A3B8');

  const brandX = pageWidth - MARGIN;
  addUniformText(pdf, 'Generated by ', brandX - 18, textY, 3.8, '#64748B', false, 'right');
  addUniformText(pdf, 'CatShare', brandX, textY, 3.8, '#16A34A', true, 'right');
}

-- =============================================================================
-- CatShare Supabase upgrade — ALL IN ONE (uuid/text casts fixed)
-- Paste into Supabase Dashboard -> SQL Editor -> Run
-- =============================================================================

-- ########## sql\SUPABASE_ORDERS_BASE.sql ##########
...
-- ########## supabase\migrations\20260612120000_order_tracking_token.sql ##########
...
-- Public read: order by tracking token only.
...
-- Public update: full edit while pending; customer may cancel.
...
-- ########## supabase\migrations\20260614120000_warehouse_inventory.sql ##########
...
-- ########## supabase\migrations\20260619130000_apply_order_inventory_untracked_skus.sql ##########
...
-- ########## supabase\migrations\20260626120000_order_status_confirmed.sql ##########

-- Add "confirmed" order status: seller locked, customer can no longer edit via tracking link.

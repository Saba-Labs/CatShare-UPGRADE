-- Run in Supabase SQL Editor (once per project) so anonymous storefronts receive
-- cataloguesDefinitionUserSettings + cataloguesDefinitionManaged from get_store_by_slug.
-- See SUPABASE_STORES_SQL.md for full stores setup context.
